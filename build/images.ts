...
export async function build() {
  for (const {id, link} of [
    ...
    {id:"bronzescales.png", link:"images/coop/UrocoIcon_02.png"},
    {id:"silverscales.png", link:"images/coop/UrocoIcon_01.png"},
    {id:"goldscales.png", link:"images/coop/UrocoIcon_00.png"},
    ...
    {id:"springfest.png", link:"images/badge/Badge_FestRankMax.png"},
    {id:"story.png", link:"images/badge/Badge_Mission_Lv01.png"},
    {id:"sideorder.png", link:"images/badge/Badge_Achievement_Sdodr_Lv03.png"},
